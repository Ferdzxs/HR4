<?php
// Payroll Administrator - Disbursements (Bank Files)
            ...
            <div
                ...
                <main class="overflow-y-auto">
                    <section class="p-4 lg:p-6 space-y-4">
                        <div>
                            <h1 class="text-lg font-semibold">Disbursements</h1>
                            <p class="text-xs text-slate-500 mt-1">Generate salary disbursement files for banks,
                                reconcile payments</p>
                        </div>
                        <div class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4">
                            <div class="text-sm text-slate-600 dark:text-slate-300">No bank files generated.</div>
                        </div>
                    </section>
                </main>
            </div>
