<?php
// Payroll Administrator - Payroll Reports
...
<head>
    ...
    <title>HR4 - Payroll Reports</title>
                ...
                <main class="overflow-y-auto">
                    <section class="p-4 lg:p-6 space-y-4">
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-1">Generate compliance-focused reports (registers,
                                reconciliations, statutory)</p>
                        </div>
