<?php
// Payroll Administrator - Payslip Generation
...
<head>
    ...
    <title>HR4 - Payslip Generation</title>
            ...
            <div
                ...
                <main class="overflow-y-auto">
                    <section class="p-4 lg:p-6 space-y-4">
                        <div>
                            <h1 class="text-lg font-semibold">Payslip Generation</h1>
                            <p class="text-xs text-slate-500 mt-1">Create and distribute payslips (individual or bulk)
                            </p>
                        </div>
                        <div class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4">
                            <div class="text-sm text-slate-600 dark:text-slate-300">No payslips generated.</div>
                        </div>
                    </section>
                </main>
            </div>
