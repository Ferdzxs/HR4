<?php
// Payroll Administrator - Deductions & Contributions
...
<head>
    ...
    <title>HR4 - Deductions & Contributions</title>
            ...
            <div
                ...
                <main class="overflow-y-auto">
                    <section class="p-4 lg:p-6 space-y-4">
                        <div>
                            <h1 class="text-lg font-semibold">Deductions & Contributions</h1>
                            <p class="text-xs text-slate-500 mt-1">Configure/manage deductions (loans, voluntary
                                contributions, benefits)</p>
                        </div>
                        <div class="rounded-lg border border-[hsl(var(--border))] overflow-hidden">
                            <div
                                class="p-3 border-b border-[hsl(var(--border))] bg-[hsl(var(--secondary))] font-semibold">
                                Deductions</div>
                            <div class="p-4 text-sm text-slate-600 dark:text-slate-300">No deduction items.</div>
                        </div>
                    </section>
                </main>
            </div>
