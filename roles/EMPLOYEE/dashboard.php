<?php
// Hospital Employee Dashboard Page
    ...
    <div id="app" class="h-screen">
        <div class="h-full flex flex-col">
            ...
            <main class="flex-1 overflow-y-auto">
                ...
                <div>
                <h1 class="text-lg font-semibold">Hospital Employee</h1>
                ...
                <div class="text-xs text-slate-500 mb-1">Leave Balance</div>
                <div class="text-2xl font-semibold">—</div>
                </div>
                <div class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4">
                <div class="text-xs text-slate-500 mb-1">Last Payslip</div>
                <div class="text-2xl font-semibold">—</div>
                </div>
                <div class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4">
                <div class="text-xs text-slate-500 mb-1">Benefits</div>
                <div class="text-2xl font-semibold">—</div>
                </div>
                <div class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4">
                <div class="text-xs text-slate-500 mb-1">Documents</div>
                <div class="text-2xl font-semibold">—</div>
                </div>
                </div>
                <div class="space-y-2">
                <div class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] text-[hsl(var(--card-foreground))] shadow-sm">
                <div class="p-4 border-b border-[hsl(var(--border))] font-semibold">Recent Activities</div>
