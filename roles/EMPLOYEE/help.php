                ...
                <main class="overflow-y-auto">
                    <section class="p-4 lg:p-6 space-y-4">
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-1">FAQs, tutorials, HR contact info, support ticket
                                submission</p>
                        </div>
                        <div class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4">
                            <div class="text-sm text-slate-600 dark:text-slate-300">How can we help you today?</div>
                        </div>
                    </section>
                </main>
            </div>
