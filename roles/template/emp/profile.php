                    ...
                    <section class="p-4 lg:p-6 space-y-4">
                        ...
                        <div class="space-y-4">
                            <div
                                ...
                                <div class="p-4 border-b border-[hsl(var(--border))] font-semibold">Personal Information
                                </div>
                                <div class="p-4 text-sm text-slate-600 dark:text-slate-300">Name, contacts, address.
                                </div>
                            </div>
                            <div
                                class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] text-[hsl(var(--card-foreground))] shadow-sm">
                                <div class="p-4 border-b border-[hsl(var(--border))] font-semibold">Employment Details
                                </div>
                                <div class="p-4 text-sm text-slate-600 dark:text-slate-300">Department, position,
                                    status.</div>
                            </div>
                            <div
                                class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] text-[hsl(var(--card-foreground))] shadow-sm">
                                <div class="p-4 border-b border-[hsl(var(--border))] font-semibold">Security Settings
                                </div>
                                <div class="p-4 text-sm text-slate-600 dark:text-slate-300">Password & 2FA
                                    configuration.</div>
                            </div>
                        </div>
                    </section>
