<?php
// Benefits Coordinator - Dashboard (Benefits Overview)
...
<head>
    ...
    <title>HR4 - Benefits Overview</title>
            ...
            <div
                ...
                <main class="overflow-y-auto">
                    <section class="p-4 lg:p-6 space-y-4">
                        <div>
                            <h1 class="text-lg font-semibold">Benefits Overview</h1>
                            <p class="text-xs text-slate-500 mt-1">Quick view of active plans, enrollment status, and
                                claim volumes</p>
                        </div>
                        ...
                        <div class="grid sm:grid-cols-2 xl:grid-cols-4 gap-4">
                            ...
                            <div class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4">
                                <div class="text-xs text-slate-500 mb-1">Enrollment Rate</div>
                                <div class="text-2xl font-semibold">—</div>
                            </div>
                            <div class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4">
                                <div class="text-xs text-slate-500 mb-1">Open Claims</div>
                                <div class="text-2xl font-semibold">—</div>
                            </div>
                            <div class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4">
                        ...
                        <div class="rounded-lg border border-[hsl(var(--border))] overflow-hidden">
                            <div
                                ...
                                Active Benefit Plans</div>
                            <div class="p-4 text-sm text-slate-600 dark:text-slate-300">No plans to show.</div>
                        </div>
                    </section>
                </main>
            </div>
