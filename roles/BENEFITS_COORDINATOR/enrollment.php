<?php
// Benefits Coordinator - Enrollment Center
                ...
                <main class="overflow-y-auto">
                    <section class="p-4 lg:p-6 space-y-4">
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-1">Handle open enrollment, mid-year changes, and HR
                                approvals</p>
                        </div>

                        <div class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4">
                            <div class="text-sm text-slate-600 dark:text-slate-300">No enrollment windows configured.
                            </div>
                        </div>
                    </section>
                </main>
