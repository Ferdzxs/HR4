<?php
// Benefits Coordinator - HMO & Benefits Management
...
<head>
    ...
    <title>HR4 - HMO & Benefits Management</title>
            ...
            <div
                ...
                <main class="overflow-y-auto">
                    <section class="p-4 lg:p-6 space-y-4">
                        <div>
                            <h1 class="text-lg font-semibold">HMO & Benefits Management</h1>
                            <p class="text-xs text-slate-500 mt-1">Create, update, and manage benefit plans (HMO,
                                insurance, wellness, retirement)</p>
                        </div>

                        <div class="rounded-lg border border-[hsl(var(--border))] overflow-hidden">
                            <div
                                class="p-3 border-b border-[hsl(var(--border))] bg-[hsl(var(--secondary))] flex items-center justify-between">
                                <div class="font-semibold">Plans</div>
                                <button
                                    class="bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] h-9 px-3 rounded-md text-sm">Add
                                    Plan</button>
                            </div>
