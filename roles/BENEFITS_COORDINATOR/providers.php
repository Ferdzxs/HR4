<?php
// Benefits Coordinator - Provider Directory
...
<head>
    ...
    <title>HR4 - Provider Directory</title>
            ...
            <div
                ...
                <main class="overflow-y-auto">
                    <section class="p-4 lg:p-6 space-y-4">
                        <div>
                            <h1 class="text-lg font-semibold">Provider Directory</h1>
                            <p class="text-xs text-slate-500 mt-1">Maintain provider records, contracts, and performance
                                notes</p>
                        </div>
                        ...
                        <div class="rounded-lg border border-[hsl(var(--border))] overflow-hidden">
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full text-sm">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="px-3 py-6 text-center text-slate-500" colspan="4">No providers
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
