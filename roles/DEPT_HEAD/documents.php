<?php
// Department Head - Department Documents
...
<head>
    ...
    <title>HR4 - Department Documents</title>
            ...
            <div
                ...
                <main class="overflow-y-auto">
                    <section class="p-4 lg:p-6 space-y-4">
                        <div>
                            <h1 class="text-lg font-semibold">Department Documents</h1>
                            <p class="text-xs text-slate-500 mt-1">HR-issued documents relevant to the department</p>
                        </div>
                        <div class="rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4">
                            <div class="text-sm text-slate-600 dark:text-slate-300">No documents available.</div>
                        </div>
                    </section>
                </main>
            </div>
