<?php
// Department Head - Staffing Cost Overview
...
<head>
    ...
    <title>HR4 - Staffing Cost Overview</title>
            ...
            <div
                ...
                <main class="overflow-y-auto">
                    <section class="p-4 lg:p-6 space-y-4">
                        <div>
                            <h1 class="text-lg font-semibold">Staffing Cost Overview</h1>
                            <p class="text-xs text-slate-500 mt-1">Aggregated salary totals of team members</p>
                        </div>
                        <div class="rounded-lg border border-[hsl(var(--border))] overflow-hidden">
                            <div
                                class="p-3 border-b border-[hsl(var(--border))] bg-[hsl(var(--secondary))] font-semibold">
                                Team Costs</div>
                            <div class="p-4 text-sm text-slate-600 dark:text-slate-300">No data available.</div>
                        </div>
                    </section>
                </main>
            </div>
