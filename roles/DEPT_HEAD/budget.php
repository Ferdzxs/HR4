<?php
// Department Head Budget Tracking Page
...
<head>
    ...
    <title>HR4 - Budget Tracking</title>
    ...
    <div id="app" class="h-screen">
        <div class="h-full flex flex-col">
            ...
            <div class="flex-1 grid <?php echo $sidebarCollapsed ? 'lg:grid-cols-[72px_1fr]' : 'lg:grid-cols-[260px_1fr]'; ?>">
                ...
                <div>
                <h1 class="text-lg font-semibold">Budget Tracking</h1>
                ...
                <div class="text-xs text-slate-500 mt-1">Set department budgets to manage spend.</div>
                </div>
                </td>
                </tr>
                </tbody>
