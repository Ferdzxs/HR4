<?php
// Department Head Performance Review Page
...
<head>
    ...
    <title>HR4 - Performance Review</title>
    ...
    <div id="app" class="h-screen">
        <div class="h-full flex flex-col">
            ...
            <main class="flex-1 overflow-y-auto">
                ...
                <select id="reviewCycle" class="flex h-10 w-full rounded-md border border-[hsl(var(--input))] bg-transparent px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring))] focus-visible:ring-offset-2">
                ...
                <th class="text-left px-3 py-2 font-semibold">Rating</th>
                ...
                <div class="text-sm font-medium">No reviews</div>
                <div class="text-xs text-slate-500 mt-1">Review items will appear per cycle.</div>
                </div>
                </td>
                </tr>
                </tbody>
