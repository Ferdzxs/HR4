<?php
// Hospital Management - Workforce Analytics
...
<head>
    ...
    <title>HR4 - Workforce Analytics</title>
            ...
            <div
                ...
                <main class="overflow-y-auto">
                    <section class="p-4 lg:p-6 space-y-4">
                        <div>
                            <h1 class="text-lg font-semibold">Workforce Analytics</h1>
                            <p class="text-xs text-slate-500 mt-1">Trends in headcount, demographics, attrition, and
                                risks</p>
                        </div>
