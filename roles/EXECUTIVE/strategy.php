<?php
// Hospital Management Strategic Planning Page
...
<head>
    ...
    <title>HR4 - Strategic Planning</title>
    ...
    <div id="app" class="h-screen">
        <div class="h-full flex flex-col">
            ...
            <div class="flex-1 grid <?php echo $sidebarCollapsed ? 'lg:grid-cols-[72px_1fr]' : 'lg:grid-cols-[260px_1fr]'; ?>">
                ...
                <tr>
                <th class="text-left px-3 py-2 font-semibold">Objective</th>
                ...
                <div class="text-sm font-medium">No strategic items</div>
                <div class="text-xs text-slate-500 mt-1">Add objectives to plan ahead.</div>
                </div>
                </td>
                </tr>
                </tbody>
