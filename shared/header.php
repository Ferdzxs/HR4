    ...
    <header class="header">
        ...
        <div class="header-right">
            ...
            <div class="hidden md:block relative">
                <input type="text" id="searchInput" placeholder="Search..." class="form-input pl-10 pr-4 py-2 w-64">
            ...
            <?php if ($userInfo): ?>
                ...
                <div class="relative">
                    <button class="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100" data-tooltip="User Menu">
                        ...
                        <div class="hidden md:block text-left">
                            <p class="text-sm font-medium text-gray-900">
                                <?php echo htmlspecialchars($userInfo['employee_name']); ?></p>
                    ...
                    <!-- Dropdown Menu -->
                    <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50 hidden"
                        id="userMenu">
